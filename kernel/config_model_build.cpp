...
config_model_build()
{
	...
	t->type(config_model_node_type::type_ipv4_address_no_zone);
	t->default_("");
	t->mandatory(false);
	t->config(true);
	...
	t->parent(cmn_interfaces_interface__ipv4_address_);
	cmn_interfaces_interface__ipv4_address_->add_child(*t);
	t->type(config_model_node_type::type_dotted_quad);
	t->default_("");
	t->mandatory(false);
	t->config(true);
	...
	t->parent(cmn_interfaces_interface__ipv4_neighbor_);
	cmn_interfaces_interface__ipv4_neighbor_->add_child(*t);
	t->type(config_model_node_type::type_phys_address);
	t->default_("");
	t->mandatory(true);
	t->config(true);
	...
	t->type(config_model_node_type::type_ipv6_address_no_zone);
	t->default_("");
	t->mandatory(false);
	t->config(true);
	...
	t->parent(cmn_interfaces_state_interface_);
	cmn_interfaces_state_interface_->add_child(*t);
	t->type(config_model_node_type::type_date_and_time);
	t->default_("");
	t->mandatory(false);
	t->config(false);
	...
	t->parent(cmn_interfaces_state_interface_);
	cmn_interfaces_state_interface_->add_child(*t);
	t->type(config_model_node_type::type_gauge64);
	t->default_("");
	t->mandatory(false);
	t->config(false);
	...
	t->parent(cmn_interfaces_state_interface__statistics);
	cmn_interfaces_state_interface__statistics->add_child(*t);
	t->type(config_model_node_type::type_counter64);
	t->default_("");
	t->mandatory(false);
	t->config(false);
	...
	t->parent(cmn_interfaces_state_interface__statistics);
	cmn_interfaces_state_interface__statistics->add_child(*t);
	t->type(config_model_node_type::type_counter32);
	t->default_("");
	t->mandatory(false);
	t->config(false);
	...
	t->parent(cmn_interfaces_state_interface__ipv4_address_);
	cmn_interfaces_state_interface__ipv4_address_->add_child(*t);
	t->type(config_model_node_type::type_ip_address_origin);
	t->default_("");
	t->mandatory(false);
	t->config(false);
	...
	t->parent(cmn_interfaces_state_interface__ipv4_neighbor_);
	cmn_interfaces_state_interface__ipv4_neighbor_->add_child(*t);
	t->type(config_model_node_type::type_neighbor_origin);
	t->default_("");
	t->mandatory(false);
	t->config(false);
	...
	t->type(config_model_node_type::type_rib_state_ref);
	t->default_("");
	t->mandatory(true);
	t->config(false);
	...
	t->type(config_model_node_type::type_interface_state_ref);
	t->default_("");
	t->mandatory(false);
	t->config(false);
	...
	t->type(config_model_node_type::type_ipv6_prefix);
	t->default_("");
	t->mandatory(false);
	t->config(true);
	...
	t->parent(cmn_routing_state_routing_instance__routing_protocols_routing_protocol_);
	cmn_routing_state_routing_instance__routing_protocols_routing_protocol_->add_child(*t);
	t->type(config_model_node_type::type_route_preference);
	t->default_("");
	t->mandatory(true);
	t->config(false);
	...
	t->parent(cmn_routing_state_routing_instance__routing_protocols_routing_protocol__connected_ribs_connected_rib_);
	cmn_routing_state_routing_instance__routing_protocols_routing_protocol__connected_ribs_connected_rib_->add_child(*t);
	t->type(config_model_node_type::type_route_filter_state_ref);
	t->default_("");
	t->mandatory(false);
	t->config(false);
	...
	t->type(config_model_node_type::type_next_hop_list_ref);
	t->default_("");
	t->mandatory(false);
	t->config(true);
	...
	t->parent(cmn_routing_state_next_hop_lists_next_hop_list__next_hop_);
	cmn_routing_state_next_hop_lists_next_hop_list__next_hop_->add_child(*t);
	t->type(config_model_node_type::type_ipv4_address);
	t->default_("");
	t->mandatory(false);
	t->config(true);
	...
	t->parent(cmn_routing_state_next_hop_lists_next_hop_list__next_hop_);
	cmn_routing_state_next_hop_lists_next_hop_list__next_hop_->add_child(*t);
	t->type(config_model_node_type::type_ipv6_address);
	t->default_("");
	t->mandatory(false);
	t->config(true);
	t->validate(cmn_routing_state_next_hop_lists_next_hop_list__next_hop__next_hop_address_validate);
	...
	t->parent(cmn_routing_state_ribs_rib__routes_route_);
	cmn_routing_state_ribs_rib__routes_route_->add_child(*t);
	t->type(config_model_node_type::type_ipv4_prefix);
	t->default_("");
	t->mandatory(false);
	t->config(true);
	...
	t->type(config_model_node_type::type_interface_ref);
	t->default_("");
	t->mandatory(false);
	t->config(true);
	...
	t->type(config_model_node_type::type_rib_ref);
	t->default_("");
	t->mandatory(false);
	t->config(true);
	...
	t->parent(cmn_routing_routing_instance__routing_protocols_routing_protocol__connected_ribs_connected_rib_);
	cmn_routing_routing_instance__routing_protocols_routing_protocol__connected_ribs_connected_rib_->add_child(*t);
	t->type(config_model_node_type::type_route_filter_ref);
	t->default_("");
	t->mandatory(false);
	t->config(true);
