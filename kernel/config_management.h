...
void config_model_node_nearest(utf8str path, config_model_node *&node, utf8str &remaining, uint64_t &pos, bool exclude_leaf);

void config_data_node_find(config_data_node *root, utf8str path, config_data_node *&node);
